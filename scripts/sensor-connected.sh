...
if [ -n "$IOT_LAB_FRONTEND_FQDN" ]; then
  ...
  n_json=$(iotlab-experiment submit -n ${SENSOR_CONNECTED_EXE_NAME} -d 20 -l grenoble,m3,${SENSOR_CONNECTED_NODE},${SENSE_FIRMWARE_HOME}/${SENSOR_CONNECTED_EXE_NAMEs}.elf,group12)
